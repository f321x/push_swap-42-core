...
/*   Updated: 2023/11/10 09:10:02 by ***REMOVED***            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	ft_space_padding(t_pf_data *data);
// void	ft_zero_padding(t_pf_data *data);
// void	ft_mod_precision(t_pf_data *data);
// void	ft_min_width(t_pf_data *data, int number_size, long long number);
// void	ft_min_width_bonus(t_pf_data *data);
